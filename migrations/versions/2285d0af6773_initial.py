...
Revision ID: 2285d0af6773
Revises: 
Create Date: 2025-11-16 13:10:10.613281
...
def upgrade():
    ...
    with op.batch_alter_table('shipments', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_shipments_origin_warehouse_id'), ['origin_warehouse_id'], unique=False)
    ...
    sa.Column('warehouse_arrived_at', sa.DateTime(), nullable=True),
    sa.Column('warehouse_has_keys', sa.Boolean(), nullable=False),
    sa.Column('warehouse_key_count', sa.Integer(), nullable=True),
    sa.Column('warehouse_title_received', sa.Boolean(), nullable=False),
    sa.Column('warehouse_title_received_at', sa.DateTime(), nullable=True),
    sa.Column('shipping_tracking_url', sa.Text(), nullable=True),
    sa.Column('title_tracking_number', sa.String(length=120), nullable=True),
...
def downgrade():
    ...
    op.drop_table('users')
    with op.batch_alter_table('shipments', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_shipments_origin_warehouse_id'))
